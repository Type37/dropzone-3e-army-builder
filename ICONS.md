...
| Supplied for this app, own grids | — | stat_mv (512), stat_a (512), stat_of (640), settings (26), rm (512), dice (32), drag_dots, military_tech, play_circle (20) |
...
| `play_circle` | **Play Mode**, on the topbar | supplied by Jet, 2026-08-17. The button wore `layers` before, so the one control that leaves the builder was marked with the symbol for the thing you were building |
