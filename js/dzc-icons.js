...
(function () {
  ...
  /* MOVE & ATTACK, drawn by Jet.
   *
   * Two files, one mark: a gun vehicle firing on the move over a double
   * chevron. Supplied as "Comic Page.zip" on 2026-08-07 and used as given —
   * the jeep on its own 420x354 grid, the chevron on 477x327 behind it, scaled
   * to the jeep's width and centred in its height. It replaces a lance-over-a-
   * route composite that was assembled here out of two unrelated Material
   * paths because there was nothing better.
   *
   * It keeps its own colours rather than taking currentColor. Every other icon
   * in the app is one flat ink; this one is a drawing, and the red muzzle
   * flash is the half that says ATTACK. */
  const MA_BODY = 'M201.622 64.242L182.133 48.5515L271.352 37.1661L273.606 55.0555L201.622 64.242ZM152.825 48.1015H101.266L86.6119 84.6345H198.128L152.825 48.1015ZM378.844 250.561C378.844 240.364 375.82 230.395 370.155 221.917C364.49 213.438 356.437 206.829 347.016 202.927C337.595 199.025 327.228 198.004 317.227 199.993C307.226 201.982 298.039 206.893 290.828 214.103C283.617 221.314 278.707 230.501 276.717 240.502C274.728 250.503 275.749 260.87 279.651 270.291C283.553 279.712 290.161 287.765 298.64 293.43C307.119 299.096 317.087 302.12 327.284 302.12C340.959 302.12 354.073 296.688 363.742 287.019C373.411 277.35 378.843 264.235 378.843 250.561H378.844ZM150.018 250.561C150.018 240.364 146.994 230.395 141.328 221.917C135.663 213.438 127.611 206.829 118.189 202.927C108.768 199.025 98.4015 198.004 88.4001 199.993C78.3987 201.982 69.2118 206.893 62.0011 214.104C54.7905 221.314 49.88 230.501 47.8906 240.502C45.9012 250.504 46.9222 260.871 50.8246 270.292C54.7269 279.713 61.3354 287.765 69.8142 293.431C78.293 299.096 88.2613 302.12 98.4587 302.12C112.133 302.12 125.247 296.688 134.916 287.019C144.585 277.35 150.018 264.235 150.018 250.561ZM403 244.428C403.001 246.992 402.416 249.521 401.291 251.824C400.166 254.127 398.53 256.143 396.507 257.718C397.526 247.875 396.434 237.927 393.303 228.539C390.172 219.151 385.075 210.538 378.352 203.276C371.629 196.014 363.435 190.269 354.315 186.425C345.196 182.581 335.362 180.726 325.469 180.984C315.576 181.242 305.852 183.606 296.945 187.92C288.038 192.234 280.154 198.398 273.819 206C267.483 213.603 262.842 222.469 260.204 232.008C257.567 241.546 256.994 251.537 258.524 261.315H167.219C168.696 251.858 168.205 242.199 165.778 232.941C163.352 223.682 159.041 215.024 153.117 207.507C147.192 199.991 139.78 193.777 131.345 189.255C122.909 184.733 113.632 182 104.092 181.226C94.5525 180.453 84.9558 181.656 75.9021 184.76C66.8484 187.864 58.5324 192.802 51.474 199.266C44.4156 205.73 38.7665 213.58 34.8801 222.327C30.9936 231.073 28.9533 240.527 28.8867 250.098C26.5497 245.999 25.5932 241.257 26.1583 236.572L39.8885 119.239C40.4218 114.666 42.6166 110.448 46.0559 107.386C49.4951 104.325 53.9392 102.634 58.5435 102.635H256.799C258.661 102.635 260.497 103.059 262.171 103.873C263.844 104.688 265.311 105.872 266.46 107.336L302.53 153.304L388.899 172.106L403 244.428ZM281.553 155.919L252.166 114.404H175.73V155.942H281.564L281.553 155.919Z';
  const MA_FLASH = 'M334.52 83.5198C308.957 58.567 349.081 64.8598 393.377 59.3956C373.665 55.4202 358.7 52.3671 347.895 49.5478C363.754 42.194 385.563 34.783 417.647 28.2957C384.948 29.7998 361.992 27.9109 344.822 24.6314C354.618 19.2708 368.392 12.6726 386.547 4.026C342.251 9.49016 304.858 25.3452 323.591 -5.07167C316.782 -0.547901 308.854 4.08532 301.274 9.09915C291.132 3.80485 283.433 -0.117952 270.471 1.48104C252.753 3.66671 237.186 23.5749 240.464 50.1523C243.743 76.7297 263.682 92.258 281.4 90.0724C294.449 88.4628 300.963 82.8534 309.601 75.1758C318.127 78.1751 326.861 80.8021 334.52 83.5197L334.52 83.5198ZM283.548 71.8896C271.316 73.3985 259.923 62.6537 258.113 47.9753C256.302 33.2968 264.742 20.1052 276.974 18.5964C280.319 18.1837 283.598 18.7967 286.638 20.0395C278.156 27.6363 272.468 36.1829 273.686 46.0542C274.903 55.9259 282.498 62.8351 292.571 68.1424C289.925 70.0863 286.893 71.4781 283.548 71.8907L283.548 71.8896Z';
  const MA_CHEV = 'M0 327L231.686 163.5L0 0V327ZM245.314 0V327L477 163.5L245.314 0Z';
  icon.moveAttack = (opts) => {
    const s = (opts && opts.size) || 20;
    return `<svg class="dzc-i dzc-i--ma" width="${s}" height="${s}" viewBox="0 0 420 354"`
      + ` aria-hidden="true" focusable="false">`
      + `<g transform="translate(0 33) scale(0.8805)" opacity=".33">`
      + `<path d="${MA_CHEV}" fill="#1EB910"/></g>`
      + `<path d="${MA_BODY}" fill="#0C0C0C"/>`
      + `<path d="${MA_FLASH}" fill="#C00F0C"/></svg>`;
  };
